...
import os
from shutil import *
PROJECT="fMRI/pRF_figureground"
project_path="/project/3018035.03/"+PROJECT
type_of_task_text = "'Anat','Task','pRF','None'"


#%%
master = Tk()
master.directory = tkFileDialog.askdirectory()
master.destroy()
...
Button(master, text='Confirm', command=spinbox_num).grid(row=1, column=1, sticky=W, pady=4)
